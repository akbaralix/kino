...
const channelUsername = "@+QU2m9AQSgVswYzYy";
...
connectMongo();
  ...
  try {
    ...
    // Foydalanuvchi kanal a'zosi yoki so‘rov yuborgan bo‘lsa ham qabul qilish
    return [
      "member",
      "creator",
      "administrator",
      "restricted" // qo‘shilish so‘rov yuborgan holatda
    ].includes(res.status);
  } catch {
    return false;
  }
